            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3">
                    ...
                    <div class="text-center mb-3">
                        <img src="{{ asset('images/phones/' . Str::slug($phone->name) . '.jpg') }}" 
                             alt="{{ $phone->name }}" 
                        ...
                        @for($i = 1; $i <= 3; $i++)
                            <div class="col-4">
                                <a href="#" class="d-block border rounded p-1">
                                    <img src="{{ asset('images/phones/' . Str::slug($phone->name) . '-' . $i . '.jpg') }}" 
                                         alt="{{ $phone->name }} - {{ $i }}" 
                                         class="img-fluid" 
                ...
                <div class="col-6 col-md-4 col-lg-3 mb-4">
                    <div class="card product-card h-100">
                        <div class="position-relative">
                            <img src="{{ asset('images/phones/' . Str::slug($relatedPhone->name) . '.jpg') }}" 
